...
| ~~Phase 2D~~ | [plan.md](./tasks/phase-2d-workflows-reports/plan.md) | ✅ 已驗收（236 tests） |
| **Phase 2E** | [plan.md](./tasks/phase-2e-misc-typescript/plan.md) | 清零剩餘 4 TS errors |
...
```text
請依 .ai-dev/tasks/phase-2e-misc-typescript/plan.md 執行。
...
*Phase 2D 已驗收。下一階段：Phase 2E → `.ai-dev/tasks/phase-2e-misc-typescript/plan.md`（清零 4 TS errors）*
