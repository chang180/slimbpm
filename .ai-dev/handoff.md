...
| **Phase 2C** | [plan.md](./tasks/phase-2c-invitations-notifications/plan.md) | Invitations Wayfinder + 頁面測試 |
...
```text
請依 .ai-dev/tasks/phase-2c-invitations-notifications/plan.md 執行。
先讀 docs/03-module-status.md（Invitations / Notifications 章節）。
...
1. **`npm run types` 仍失敗（5 errors）** — invitations 型別（2C）、app-header、DynamicForm、enhanced-select（2E）。
...
*Phase 2B 已驗收。下一階段：派工 Phase 2C → `.ai-dev/tasks/phase-2c-invitations-notifications/plan.md`*
