...
## 最後更新：2026-06-06（Phase 1 全部驗收完成）
...
| **Phase 2A** | [plan.md](./tasks/phase-2a-users/plan.md) | Users Create/Edit TS 修復 |

**Phase 1（1A–1D）已全部完成。** 進入 Phase 2 模組硬化。

### 派工指令範本

```text
請依 .ai-dev/tasks/phase-2a-users/plan.md 執行。
先讀 docs/03-module-status.md（Users 章節）。
...
1. **`npm run types` 仍失敗（38 errors）** — 主要在 Users Create/Edit（Phase 2A）。
2. ~~**Dashboard 假操作**~~ — Phase 1C 已驗收。
3. ~~**表單前端路由缺口**~~ — Phase 1B 已驗收。
4. ~~**組織設定 demo 化**~~ — Phase 1D 已驗收。
...
*Phase 1 已全部驗收。下一階段：派工 Phase 2A → `.ai-dev/tasks/phase-2a-users/plan.md`*
