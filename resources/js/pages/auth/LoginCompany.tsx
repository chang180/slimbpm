...
import { Building2, Lock, ArrowLeft, Shield } from 'lucide-react';
...
export default function LoginCompany({ organization }: LoginCompanyProps) {
    ...
    const submit: FormEventHandler = (e) => {
        e.preventDefault();
        post(route('company.login', { slug: organization.slug }));
    };

    return (
        <>
            <Head title={`${organization.name} - 後台登入`} />
                        ...
                        <CardContent>
                            ...
                            <div className="mt-6 text-center">
                                <p className="text-sm text-gray-600 dark:text-gray-400">
                                    一般員工請使用{' '}
                                    <Link
                                        href={route('portal.login', { slug: organization.slug })}
