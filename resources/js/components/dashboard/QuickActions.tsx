...
type Action = HrefAction | ClickAction;

export default function QuickActions({ userRole, organizationSlug: _organizationSlug, onInviteMembers, onSendBulkInvites }: QuickActionsProps) {
    ...
    const getActionsForRole = (): Action[] => {
    ...
    return (
        <Card>
            <CardHeader>
                ...
                <p className="text-sm text-gray-600 dark:text-gray-400">根據您的權限顯示可用的操作選項</p>
            </CardHeader>
            <CardContent>
                ...
                <div className="mt-6 p-4 bg-blue-50 dark:bg-blue-900/20 rounded-lg">
                    <div className="flex items-start gap-3">
                        ...
                        <div>
                            <h4 className="font-medium text-blue-900 dark:text-blue-100">權限說明</h4>
                            <p className="text-sm text-blue-700 dark:text-blue-300 mt-1">
                                您的角色是{' '}
                                <strong>
                                    {userRole === 'admin' ? '系統管理員' : userRole === 'manager' ? '部門主管' : '一般用戶'}
                                </strong>
